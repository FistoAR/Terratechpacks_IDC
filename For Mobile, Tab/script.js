...
// const revealImages1 = document.querySelectorAll(".revealimage1 img");

// revealImages1.forEach((img, index) => {
//   gsap.from(img, {
//     scrollTrigger: {
//       trigger: img,
//       start: "top 95%",         // animation starts when img is 85% in viewport
...
//   });
// });
// Combined approach - selects both img and div
const revealElements = document.querySelectorAll(".revealimage img, .revealimage div");
...
const revealElements1 = document.querySelectorAll(".revealimage1 img, .revealimage1 div");

revealElements1.forEach((element, index) => {
  gsap.from(element, {
    scrollTrigger: {
      trigger: element,
      start: "top 95%",
